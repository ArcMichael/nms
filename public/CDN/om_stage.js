...
var s_account="sphc-dragonsite-dev"
...
s.linkInternalFilters="javascript:,sephora.cn"
...
s.visitorNamespace="sephorachina"
s.trackingServer="sephorachina.sc.omtrdc.net"
...
function s_doPlugins(s) {
	...
	/* Setting Custom Product View Event */
	...
	if(!s.campaign)	{
		/*AD source*/
		var campaign = s.getQueryParam('rsour');	
		/*AD media*/
		var source = s.getQueryParam('rmeth');	
		/*AD group*/
		var medium = s.getQueryParam('radgr');
		/*AD series*/
		var term = s.getQueryParam('rcamp');
		/*AD content*/
		var content = s.getQueryParam('rcont');
		/*AD channel*/
		var channel = s.getQueryParam('rchan');
		var none = 'na';
		var s_campaign,s_sourchannel;
		...
		s_campaign=campaign+"|"+source+"|"+medium+"|"+term+"|"+content+"|"+channel;
		if(s_campaign!=null&&s_campaign!=""&&s_campaign!="na|na|na|na|na|na")
			s.campaign=	 s_campaign;
	}
	s.campaign=s.getValOnce(s.campaign,'s_campaign',0);
	
	/* Set Campaign Stacking*/
	if(source!=null&&source!=""&&source!="na") {
		s.eVar19=s.crossVisitParticipation(source,'s_ev19','30','5','>','purchase');
		s.eVar15=s.crossVisitParticipation(campaign+"|"+source,'s_ev15','30','5','>','purchase');
	}

	/* Determine whether visitor is New or a Repeat visitor within the last 365 days */
	s.eVar10=s.getNewRepeat(365);
	
	/* Automatically Product Link Extraction */
	s.eVar24=s.getQueryParam("prodlink");
	
	/* Automatically Keywords Link Extraction */
	s.eVar23=s.getQueryParam("kwrec");
	...
	/*Setting Visitor Status*/	
	if(s.eVar21)
		s.prop10=s.eVar21;
		
	/* Automate Finding Method eVar */
	if(!s.eVar1)
	s.eVar1=s.getQueryParam('merch');
...
+"(s.debugTracking){var d='AppMeasurement Debug: '+rs,dl=s.sp(rs,'&'),dln;for(dln=0;dln<dl.length;dln++)d+=\"\\n\\t\"+s.epa(dl[dln]);s.logDebug(d)}im.common=rs;if((!ta||ta=='_self'||ta=='_top'||(s.wd.na"
...
+"'),\"\\t\",''),' ','');x=2}else if(t=='INPUT'||t=='SUBMIT'){if(o.value)n=o.value;else if(o.innerText)n=o.innerText;else if(o.textContent)n=o.textContent;x=3}else if(o.common&&t=='IMAGE')n=o.common;if(n){"
...
+".type=\"text/javascript\";'+(n?'o.id=i;o.defer=true;o.onload=o.onreadystatechange=f1;o.f2=f2;o.l=0;':'')+'o.common=u;c.appendChild(o);'+(n?'o.c=0;o.i=setTimeout(f2,100)':'')+'}}catch(e){o=0}return o')"
