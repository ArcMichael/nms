...
/**
 * Gets the nearest src ancestor ID of two IDs.
 *
 * Using this ID scheme, the nearest src ancestor ID is the longest src
 * prefix of the two IDs that immediately preceded a "marker" in both strings.
 *
 * @param {string} oneID
 * @param {string} twoID
 * @return {string} Nearest src ancestor ID, or the empty string if none.
 * @private
 */
...
var ReactInstanceHandles = {
   ...
   *
   * NOTE: Does not invoke the callback on the nearest src ancestor because
...
function instantiateReactComponent(node) {
  ...
  if ("development" !== 'production') {
    "development" !== 'production' ? warning(typeof instance.construct === 'function' && typeof instance.mountComponent === 'function' && typeof instance.receiveComponent === 'function' && typeof instance.unmountComponent === 'function', 'Only React Component.md can be mounted.') : undefined;
  }
